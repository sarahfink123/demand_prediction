...
def preprocess_adr(df: pd.DataFrame) -> pd.DataFrame:
    ...
    ####### SCALING ########################################################################################
    # Scaling
    features_to_robust = ['lead_time', 'total_stays', 'adults', 'FUEL_PRCS']
    ...
    robust_scaler_path = os.path.join(folder_path, 'robust_scaler_adr.pkl')
    minmax_scaler_path = os.path.join(folder_path, 'minmax_scaler_adr.pkl')
    onehot_encoder_path = os.path.join(folder_path, 'onehot_encoder_adr.pkl')
    column_order_path = os.path.join(folder_path, 'column_order_adr.pkl')
...
def preprocess_adr_X_pred(df: pd.DataFrame) -> pd.DataFrame:
    #######################################################################################################
    # Load the scalers and encoders
    folder_path = os.path.dirname(__file__)
    r_scaler_path = os.path.join(folder_path, "robust_scaler_adr.pkl")
    m_scaler_path = os.path.join(folder_path, "minmax_scaler_adr.pkl")
    ohe_path = os.path.join(folder_path, "onehot_encoder_adr.pkl")
    column_order_path = os.path.join(folder_path, 'column_order_adr.pkl')
